   ...
   <div className="collapse navbar-collapse" id="navbarNav" >
     <ul className="navbar-nav">
       <li className="nav-item">
         <a className="nav-link active" aria-current="page" href="/home2" style={{color:"white",marginLeft:300}}>|Home </a>
       </li>
       <li className="nav-item">
         <a className="nav-link" href="/account" style={{color:"white"}}>|Account</a>
       </li>
       <li className="nav-item">
       ...
       <li className="nav-item">
         <a className="nav-link" href="#" style={{color:"white"}}>|Feedback</a>
       </li>
       <li className="nav-item">
